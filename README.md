...
The OpenAgri Irrigation service provides the ability to calculate referent evapotranspiration (ETo) as well as to analyze \
the soil moisture of some parcel/plot of land. \
These functionalities can be used via the REST APIs, which provide these resources in a linked data format (using JSON-LD). \
